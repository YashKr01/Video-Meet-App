...
import com.yash.videomeet.network.ApiClient;
import com.yash.videomeet.network.ApiService;
...
public class OutgoingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null) {
            textFirstChar.setText(String.format(user.firstName.substring(0, 1)));
        ...
        imageStopInvitation.setOnClickListener(view -> {
            ...
            if (getIntent().getBooleanExtra("isMultiple", false)) {
                ...
                cancelInvitationResponse(null, receivers);
            } else {
                if (user != null) {
                    cancelInvitationResponse(user.token, null);
                }
            }
        });
                    ...
                    public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                        if (response.isSuccessful()) {
                            if (type.equals(Constants.REMOTE_MSG_INVITATION)) {
                                Toast.makeText(OutgoingInvitationActivity.this, "Invitation sent successfully",
    ...
    private void cancelInvitationResponse(String receiverToken, ArrayList<User> receivers) {
        try {
    ...
    protected void onStart() {
        ...
        LocalBroadcastManager.getInstance(getApplicationContext())
                .registerReceiver(invitationResponseReceiver, new IntentFilter(Constants.REMOTE_MSG_INVITATION_RESPONSE));
    }
